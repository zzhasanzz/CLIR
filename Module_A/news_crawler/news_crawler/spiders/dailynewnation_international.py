...
class DailyNewNationInternationalSpider(scrapy.Spider):
    name = "dailynewnation_international"
    allowed_domains = ["dailynewnation.com"]

    BASE_URL = "https://dailynewnation.com/news/category/todays-news/international"
    MAX_PAGES = 50
    MAX_ARTICLES = 200
