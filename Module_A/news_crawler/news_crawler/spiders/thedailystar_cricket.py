...
class DailyStarCricketSpider(scrapy.Spider):
    name = "thedailystar_cricket"
    ...
    def parse_ajax(self, response):
        ...
        yield scrapy.Request(
            ...
            headers={
                "X-Requested-With": "XMLHttpRequest",
                "Accept": "application/json",
                "Referer": "https://www.thedailystar.net/sports/cricket"
            }
        )
    ...
    def parse_article(self, response):
        ...
        yield {
            ...
            "section": "sports/cricket",
            "tokens": len(body.split())
        }

    # --------------------------------------------------
    # AJAX URL BUILDER (CRICKET)
    # --------------------------------------------------
    def build_ajax_url(self, page):
        return (
            ...
            "&view_args=36"
            "&view_path=%2Ftaxonomy%2Fterm%2F36"
            "&pager_element=0"
            f"&page={page}"
            "&_drupal_ajax=1"
        )
